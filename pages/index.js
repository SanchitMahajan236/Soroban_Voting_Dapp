    ...
    <>
      ...
      <div className="container ">
            ...
            <div className="col-md-5 col-lg-4 order-md-last">
              <ul className="list-group mb-1">
                <li className="list-group-item d-flex justify-content-between" style={{ backgroundColor: '#00000090' }}>
                  <div>
                    <h6 className="my-0 text-white">Created by: Sanchit Mahajan</h6>
                  </div>
                </li>
            ...
            <div className=" mb-2">
              <div className="card">
                ...
                <div className="card-body">
                  <h5 className="card-title mt-3">Soroban's community of Blockchain Developers</h5>
        ...
        <footer className="my-5 pt-5 text-muted text-center text-small">
          <p style={{ color: 'white' }} className="mb-1">&copy; 2024 Sanchit Mahajan</p>
